              ...
              {selectedServices.some(hasServiceDetails) && (
                <div>
                  ...
                  <div className="max-h-75 space-y-3 overflow-y-auto pr-1">
                    {selectedServices.filter(hasServiceDetails).map((service) => {
                        ...
                        <div key={service.id} className="overflow-hidden rounded-lg border-2 border-gray-200">
                          ...
                          <div className="p-3">
                            <ServiceDetailFields
                              ...
                              onDetailChange={(field, value) => handleServiceDetailChange(id, field, value)}
                              onListToggle={(field, value) => handleListToggle(id, field, value)}
                            />
                          </div>
                        </div>
                      );
