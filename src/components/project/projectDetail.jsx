...
const ProjectManagement = () => {
  ...
  const allServices = {
    digitalMarketing: ['Website', 'SEO', 'SMM', 'Ads', 'Web App'],
    media: ['Videography', 'Video Editing', 'Photography', 'Video Production'],
    design: ['Branding Logo', 'Brochure', 'Pamphlet', 'Social Media Designs', 'Marking collateral', 'UI/UX designer']
  };
  ...
  const renderServiceFields = (service, isView = false) => {
    ...
    // Media and Design services - no details
    return null;
  };
