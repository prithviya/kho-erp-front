            ...
            <div className="flex min-h-full items-center justify-center p-4">
              ...
              <div className="relative bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="px-6 py-6">
                  ...
                  {/* EDUCATION */}
                  {selectedApplication.academics &&
                    selectedApplication.academics.length >
                      0 && (
                  ...
                  {selectedApplication.experiences &&
                    selectedApplication.experiences.length >
                      0 && (
                  ...
                  <div className="flex flex-wrap gap-3 pt-4 border-t border-gray-200">
                    ...
                    <button
                      onClick={() => { updateStatus( selectedApplication.cifid,'Selected' );}} disabled={updating} className="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors disabled:opacity-50">
                      Select
                    </button>


                    <button onClick={() => { updateStatus( selectedApplication.cifid, 'Rejected' ); }} disabled={updating} className="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition-colors disabled:opacity-50">
                      Reject
                    </button>
