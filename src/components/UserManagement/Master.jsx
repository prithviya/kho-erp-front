 ...
 const [departmentForm, setDepartmentForm] = useState(initialDepartmentForm);
  ...
  const handleDepartmentSubmit = async (event) => {
    ...
    try {
        ...
        // Reload departments and update the table
        await loadMasterData();
    ...
    <div className="max-h-[calc(100vh-110px)] overflow-y-auto space-y-5 p-4 sm:p-5">
      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-2 gap-5">
          <TableSection title="Lead Source" subtitle="Manage lead source lookup" count={leadSources.length} countClass="bg-violet-50 text-violet-700" onAdd={() => openCreateModal("source")}>
